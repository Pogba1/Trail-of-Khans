...
diplomacy = {
    ...
    BREAKTRUCE_INFAMY_CLEAR_UNION_SPHERE = 5, -- Infamy for breaking truce for asserting hegemony
    ...
    TWS_FULFILLED_IDLE_SPACE = 0.51, -- How much % the CB fulfillment must done, so TWS starts ticking.
